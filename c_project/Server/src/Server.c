...
void isValidAccountTest(void)
{
	...
	if( isValidAccount(&card2,&accountsDB[0]) == CARD_OK)
	{
...
{
	scanf("%s",array[0].cardHolderData.cardHolderName);
	scanf("%s",array[1].cardHolderData.cardHolderName);
	scanf("%s",array[0].cardHolderData.cardExpirationDate);
	scanf("%s",array[1].cardHolderData.cardExpirationDate);
	scanf("%s",array[0].cardHolderData.primaryAccountNumber);
	scanf("%s",array[1].cardHolderData.primaryAccountNumber);
